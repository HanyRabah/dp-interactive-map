...
interface ProjectFormProps {
	...
	handleStartEditing: (polygonId: string, style?: PolygonStyle) => void;
}
		...
		<Box component="form" onSubmit={onSubmit} sx={{ width: "100%" }}>
			<Grid container spacing={2}>
				...
				<Grid size={{ xs: 12 }}>
					<FormControlLabel
						control={
							<Checkbox checked={formData.hideMarker} onChange={e => updateFormData("hideMarker", e.target.checked)} />
						}
						label="Hide Marker"
					/>
				</Grid>
				...
				<Grid size={{ xs: 12 }}>
					<Grid
						...
						{!formData.polygon && (
							<Button variant="outlined" startIcon={<AddIcon />} onClick={() => setMode(MODES.DRAW)}>
								Draw Polygon
							</Button>
						)}
					</Grid>
