...
import { Feature, Marker, Mode, MODES } from "@/types/drawMap";
		...
		<div className="space-y-4">
			<div className="flex justify-between items-center">
				...
				{(selectedFeature || selectedMarker) && (
					<DeleteButton onClick={onDelete} type={mode === MODES.MARKER ? "marker" : "feature"} />
				)}
			</div>
			...
			{mode === MODES.DRAW ? (
				selectedFeature ? (
					<div className="p-4 bg-white rounded shadow">
						...
						<p className="text-sm">Type: {JSON.stringify(selectedFeature.geometry.type)}</p>
