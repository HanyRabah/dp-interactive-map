...
import { Image as ImageIcon, Play } from "lucide-react"; // Import icons from lucide-react
		...
		<AnimatePresence>
					...
					<motion.div
						...
						<motion.div
							...
							<motion.div
								...
								<motion.div className="flex justify-between items-center group cursor-pointer" whileHover="hover">
									<div>
										<motion.h2
			...
			{videoPlayerOpen && (
				<VideoPlayer
					...
					videoUrl={project.polygon.popupDetails.videoLink}
				/>
			)}
		</AnimatePresence>
	);
